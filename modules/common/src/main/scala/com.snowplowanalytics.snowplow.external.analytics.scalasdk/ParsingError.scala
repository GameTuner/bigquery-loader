/*_ <- EitherT.rightT_ <- EitherT.rightT
...
import com.snowplowanalytics.snowplow.external.analytics.scalasdk.decode.Key
import com.snowplowanalytics.snowplow.external.analytics.scalasdk.decode.Key._
