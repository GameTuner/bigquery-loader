...
import com.snowplowanalytics.snowplow.external.analytics.scalasdk.Data.{ShreddedType, UnstructEvent}
...
class ResourcesSpec extends Specification {
  ...
  "aggregateTypes" should {
    import com.snowplowanalytics.snowplow.storage.bigquery.streamloader.Resources.aggregateTypes
